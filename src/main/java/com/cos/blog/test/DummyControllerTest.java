...
public class DummyControllerTest {
	...
	public User detail(@PathVariable int id) {
		...
		// 그럼 return null 이 리턴 됨.. 그럼 프로그램에 문제가 됨
		// Optional로 너의 user 객체를 감싸서 가져올테니 null인지 아닌지 판단해서 return 함
...
//		});
		...
		// 만약에 자바 오브젝트를 리턴 하게 되면 MessageConverter가 Jackson 라이브러리르 호출해서
